...
const api = {
  ...
  openDashboardWindow: () => ipcRenderer.invoke("window:open-dashboard") as Promise<void>,
  closeCurrentWindow: () => ipcRenderer.invoke("window:close-self") as Promise<void>,
  snoozeQuizPopup: (attemptId: string) => ipcRenderer.invoke("quiz-popup:snooze", attemptId) as Promise<void>,
  completeQuizPopup: (attemptId: string) => ipcRenderer.invoke("quiz-popup:complete", attemptId) as Promise<void>,
  ...
  openAccessibilitySettings: () => ipcRenderer.invoke("permissions:open-accessibility-settings") as Promise<void>,
